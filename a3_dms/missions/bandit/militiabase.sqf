...
_msgStart = ['#DE5021',format ["A militia base has been located at %1! There are reports of heavy weapon crate inside of it...",mapGridPosition _pos]];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully assaulted the militia base and obtained the crate!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"Seems like the militia packed up and drove away..."];
// Define mission name (for map marker and logging)
_missionName = "Militia Base";
// Create Markers
_markers =
[
	_pos,
