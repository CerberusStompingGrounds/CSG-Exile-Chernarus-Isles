...
_msgStart = ['#DE5021',"A truck carrying humanitarian supplies has been seized by militia men. Stop them!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully claimed the humanitarian supplies for themselves!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The militia men have taken the humanitarian supplies and escaped..."];
