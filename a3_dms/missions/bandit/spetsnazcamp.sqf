...
_msgStart = ['#DE5021',"Capture the spetsnaz camp!"];
_group =
[
	_pos,					// Position of AI
	_AICount,				// Number of AI
	_difficulty,			// "random","hardcore","difficult","moderate", or "easy"
	"officer", 				// "random","assault","MG","sniper" or "unarmed" OR [_type,_launcher]
...
if (_difficulty isEqualTo "hardcore") then
{
	...
	_vehicle = ["rhs_tigr_msv",_pos getPos [30, random 360],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	_msgWIN = ['#DE5021',format ["Survivors have overtaken the camp, entry code for Tigr is %1...",_pinCode]];
} else
{
	_vehicle = ["rhs_tigr_msv",_pos getPos [30, random 360]] call DMS_fnc_SpawnNonPersistentVehicle;
	_msgWIN = ['#DE5021',"Survivors have captured the camp"];
};
...
_msgLOSE = ['#DE5021',"The camp was ransacked..."];
// Define mission name (for map marker and logging)
_missionName = "Spetsnaz Camp";
