private ["_num", "_group", "_pos", "_side", "_extraParams", "_OK", "_difficulty", "_AICount", "_type", "_launcher", "_crate1", "_rndDir", "_vehClass1", "_vehicle1", "_vehClass2", "_vehicle2", "_crate_loot_values1", "_missionAIUnits", "_missionObjs", "_msgStart", "_msgWIN", "_msgLOSE", "_missionName", "_markers", "_time", "_added", "_cleanup"];
...
_rndDir = random 180;
_vehClass1 = "rhsusf_m1025_w";
_vehClass2 = "rhsusf_m998_w_4dr";
...
_msgStart = ['#DE5021',"Militia have stolen vehicles from the army. Kill them and take it for yourselves!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have secured the military vehicle and eliminated the militia!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The milita have escaped with the car and left nothing but a trail of smoke..."];
// Define mission name (for map marker and logging)
_missionName = "Army Vehicle";
// Create Markers
_markers =
[
	_pos,
