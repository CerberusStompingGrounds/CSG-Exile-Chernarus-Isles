...
_msgStart = ['#DE5021',"The militia set up a field hospital. Seize it for your own!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have claimed the medical supplies!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The militia ran off with the medical supplies! Everything is gone!"];
// Define mission name (for map marker and logging)
_missionName = "Field Hospital";
// Create Markers
_markers =
[
	_pos,
