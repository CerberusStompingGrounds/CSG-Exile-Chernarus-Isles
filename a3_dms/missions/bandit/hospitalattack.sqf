...
//_msgStart = ['#DE5021',format["A field hospital is under attack! Go kill the %1 attackers",_difficulty]];
_msgStart = ['#DE5021',"A field hospital is under attack! Go kill the attackers"];
...
if (_difficulty isEqualTo "hardcore") then {
												...
												_msgWIN = ['#DE5021',format ["Survivors freed the hospital and got free meds, entry code is %1...",_pinCode]];
											} else
											{
												...
												_msgWIN = ['#DE5021',"Survivors freed the hospital and got free meds"];
											};
// Create Crate type
...
_msgLOSE = ['#DE5021',"The attackers killed the medics and stole everything!"];
