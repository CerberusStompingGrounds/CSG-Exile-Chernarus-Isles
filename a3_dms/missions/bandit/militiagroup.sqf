...
_msgStart = ['#DE5021',"A group of militia has been spotted. Kill them and take their equipment!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully eliminated the militia"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The militia have escaped and they took all their loot with them..."];
// Define mission name (for map marker and logging)
_missionName = "Militia Group";
// Create Markers
_markers =
[
	_pos,
