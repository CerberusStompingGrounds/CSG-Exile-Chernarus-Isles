...
_msgStart = ['#DE5021',format ["A band of thieves are attempting to break into a %1. Eliminate them and you might get the car for yourself!",getText (configFile >> "CfgVehicles" >> _class >> "displayName")]];
// Define Mission Win message
_msgWIN = ['#DE5021',format ["Survivors have eliminated the thieves! Looks like the thieves managed to figure out that the code was %1...",_pinCode]];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The thieves cracked the code and drove off..."];
