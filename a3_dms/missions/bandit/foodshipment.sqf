...
_msgStart = ['#DE5021',"A food supply truck has been seized by the militia. Stop them!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully claimed the food supplies!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The militia have taken the food supplies and escaped!"];
// Define mission name (for map marker and logging)
_missionName = "Food Shipment";
// Create Markers
_markers =
[
	_pos,
