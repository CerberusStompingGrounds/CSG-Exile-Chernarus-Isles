...
_msgStart = ['#DE5021',"A heli has landed at a base! Go kill them and steal the heli"];
_group =
[
	_pos,					// Position of AI
...
if (_difficulty isEqualTo "easy") then
{
	...
	_msgWIN = ['#DE5021',"Survivors killed everyone and made off with the heli."];
}
else
{
	_pinCode = (1000 +(round (random 8999)));
	_vehicle = [_VehicleClass,[(_pos select 0) -30, (_pos select 1) -30, 0],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	_msgWIN = ['#DE5021',format ["Survivors killed everyone and made off with the heli, entry code %1...",_pinCode]];
};
// Create Crate type
...
_msgLOSE = ['#DE5021',"The attackers flew off and escaped attack..."];
// Define mission name (for map marker and logging)
_missionName = "Helicopter Steal";
// Create Markers
_markers =
[
	_pos,
