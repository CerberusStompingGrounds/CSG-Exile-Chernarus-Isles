...
_msgStart = ['#DE5021',"A group of mercenaries have set up a construction site. Clear them out!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully demolished the construction site!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The mercenaries have dismantled their construction site and escaped..."];
