...
_msgStart = ['#DE5021',"A battalion is patrolling in survivor territory. Deal with them!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully taken care of the battalion"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The battalion has escaped and are now planning their next raid..."];
// Define mission name (for map marker and logging)
_missionName = "Militia Battalion";
// Create Markers
_markers =
[
	_pos,
