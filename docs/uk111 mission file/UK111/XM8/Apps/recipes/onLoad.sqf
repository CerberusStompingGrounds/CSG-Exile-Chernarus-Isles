private ["_pW", "_pH", "_footTop", "_slideClass", "_newParent", "_display", "_slide", "_recipesCategories", "_goCraftBtn", "_backbtn", "_recipeList", "_recipesPic", "_RecipePic", "_componentsList", "_RecipeCategories", "_j", "_CategoryConfig", "_RecipeCategory"];
_display = _this select 0;
_slide = _this select 1;
disableSerialization;
_pW = 0.025;
_pH = 0.04;
_footTop = 0.04;
_slideClass = "APPS_recipes";
_newParent = [_display,_slide,([_slideClass,"ctrlGrp"] call XM8_Apps_fnc_getNextIDC),[0, -0.03, 34 * _pW, 0.76]] call XM8_Apps_fnc_createCtrlGrp;
...
_recipeList ctrlSetEventHandler ["LBSelChanged", "_this call fnc_recipeComponents_Load;"];
...
_RecipePic ctrlSetText "UK111\XM8\Apps\recipes\logo.paa";
