...
if (ExilePlayerInSafezone) exitWith { ["ErrorTitleAndText",["Access Denied!","You are not allowed to do this inside a safe zone."]] call ExileClient_gui_toaster_addTemplateToast; };
