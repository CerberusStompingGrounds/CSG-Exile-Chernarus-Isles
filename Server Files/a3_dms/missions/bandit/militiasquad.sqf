...
_msgStart = ['#DE5021',"A squad of volunteers have gotten lost! Eliminate them!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully eliminated the squad!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The volunteers escaped! Turns out the map was upside down..."];
// Define mission name (for map marker and logging)
_missionName = "Militia Squad";
// Create Markers
_markers =
[
	_pos,
