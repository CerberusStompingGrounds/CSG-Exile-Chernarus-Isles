...
_msgStart = ['#DE5021',"A militia fireteam has been spotted, eliminate them!"];

// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have defeated the militia!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The militia ran off..."];
// Define mission name (for map markers, mission messages, and logging)
_missionName = "Militia Fireteam";
// Create Markers
_markers =
[
	_pos,
