...
_msgStart = ['#DE5021',"An SUV has been stolen. Steal it again!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors secured the SUV!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The SUV was sold for parts. Rest in pieces..."];
// Define mission name (for map marker and logging)
_missionName = "Stolen SUV";
// Create Markers
_markers =
[
	_pos,
