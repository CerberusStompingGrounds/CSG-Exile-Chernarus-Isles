...
//_msgStart = ['#DE5021',format["Some %1 militia are out stealing supplies!",_difficulty]];
_msgStart = ['#DE5021',"Bandits have secured a construction supplies site, capture it!"];
_crate_item_list = ["Exile_Item_Cement","Exile_Item_Cement","Exile_Item_Cement","Exile_Item_Cement","Exile_Item_Sand","Exile_Item_Sand","Exile_Item_Sand","Exile_Item_Sand","Exile_Item_FuelCanisterFull","Exile_Item_FuelCanisterFull","Exile_Item_WaterCanisterDirtyWater","Exile_Item_WaterCanisterDirtyWater","Exile_Item_WaterCanisterDirtyWater","Exile_Item_WaterCanisterDirtyWater","Exile_Item_MetalPole","Exile_Item_MetalPole","Exile_Item_MetalPole","Exile_Item_MetalPole","Exitem_blueprint_concretebuilding"];
_group =
[
	_pos,					// Position of AI
...
if (_difficulty isEqualTo "hardcore") then
{
	...
	_vehicle = ["RHS_Ural_Civ_01",_pos getPos [30, random 360],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	_msgWIN = ['#DE5021',format ["Survivors have got their hands on the supplies, entry code for Ural is %1...",_pinCode]];
} else
{
	_vehicle = ["RHS_Ural_Civ_01",_pos getPos [30, random 360]] call DMS_fnc_SpawnNonPersistentVehicle;
	_msgWIN = ['#DE5021',"Survivors have got their hands on the supplies"];
};
...
_msgLOSE = ['#DE5021',"The militia stole it all..."];
// Define mission name (for map marker and logging)
_missionName = "Building Depot";
