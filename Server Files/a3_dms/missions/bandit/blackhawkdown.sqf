...
_wreck = createVehicle ["BlackhawkWreck",[(_pos select 0) - 10, (_pos select 1),-0.2],[], 0, "CAN_COLLIDE"];
...
_msgStart = ['#DE5021',"We got a Blackhawk down, Super 6-1 is down, secure the perimeter and claim what can be claimed!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have secured the blackhawk and claimed the remaining loot!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The blackhawk has been seized by the enemy and the loot has been destroyed"];
