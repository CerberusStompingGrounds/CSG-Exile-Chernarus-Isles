...
_msgStart = ['#DE5021',"A team of militia men have set up a bunker. Capture it!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully taken care of the militia and their bunker!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The militia men became impatient and have escaped the area..."];
// Define mission name (for map marker and logging)
_missionName = "Militia Bunker";
// Create Markers
_markers =
[
	_pos,
