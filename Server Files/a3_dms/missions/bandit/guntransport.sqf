...
_msgStart = ['#DE5021',"A gun transport truck has crashed. Secure the crash site!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully secured the area and claimed the guns for their own!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The transport truck has been repaired and driven off..."];
