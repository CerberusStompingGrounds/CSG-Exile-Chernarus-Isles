...
switch (_difficulty) do
{
	...
	case "moderate":
	{
		...
		_msgStart = ['#DE5021',"Snipers have set up a moderate training camp, go steal their rifles"];
	...
	_msgStart = ['#DE5021',"Snipers have set up a difficult training camp, go steal their rifles"];
	...
	default
	{
		...
		_msgStart = ['#DE5021',"Snipers have set up an advanced training camp, go steal their rifles"];
...
//_msgStart = ['#DE5021',format["Snipers have set up a %1 training camp, go steal their rifles",_difficulty]];
_msgStart = ['#DE5021',"Snipers have set up a training camp, go steal their rifles"];
...
if (_difficulty isEqualTo "hardcore") then
{
	...
	_msgWIN = ['#DE5021',format ["Survivors have killed the snipers and stolen their rifles,the truck code is %1...",_pinCode]];
	_group =
	[
...
else
{
	...
	_msgWIN = ['#DE5021',"Survivors have killed the snipers and stolen their rifles"];
	_group =
	[
...
_msgLOSE = ['#DE5021',"The Snipers have packed up and left, no rifles for you..."];
