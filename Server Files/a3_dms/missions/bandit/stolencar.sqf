...
_msgStart = ['#DE5021',"Terrorists with a stolen car have broken down. Naturally you should kill them and steal the car again!"];
_group =
[
	_pos,					// Position of AI
...
_msgWIN = ['#DE5021',format ["Survivors killed everyone and made off with the car, entry code %1",_pinCode]];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The bastards stole the car"];
// Define mission name (for map marker and logging)
_missionName = "Stolen Car";
// Create Markers
_markers =
[
	_pos,
