...
_msgStart = ['#DE5021',"A transport van carrying beer and guns is being robbed, stop the militia and steal the loot!"];
// Define Mission Win message
_msgWIN = ['#DE5021',"Survivors have successfully claimed all of the beer and guns!"];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The militia have taken off with all the beer and all the guns..."];
