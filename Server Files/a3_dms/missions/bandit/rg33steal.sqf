/*
	RG-33 Mission with new difficulty selection system
...
switch (_difficulty) do
{
	case "easy":
	{
		_msgWIN = ['#DE5021',"Survivors killed everyone and made off with the RG-33"];
	...
	case "moderate":
	{
		...
		else
		{
			...
			_msgWIN = ['#DE5021',format ["Survivors killed everyone and made off with the RG-33, entry code %1...",_pinCode]];
		};
	};
	case "difficult":
	{
...
//_msgStart = ['#DE5021',format["An RG-33 is parked at a small %1 base! Go kill them and steal it",_difficulty]];
_msgStart = ['#DE5021',"An RG-33 is parked at a small base! Go kill them and steal it"];
_group =
[
	_pos,					// Position of AI
...
_msgLOSE = ['#DE5021',"The attackers drove off in the RG-33 and the base escaped attack."];
// Define mission name (for map marker and logging)
_missionName = "RG-33 Steal";
// Create Markers
_markers =
[
	_pos,
