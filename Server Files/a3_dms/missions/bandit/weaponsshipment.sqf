...
//_msgStart = ['#DE5021',format["Some %1 terrorists are out stealing guns, get in first!",_difficulty]];
_msgStart = ['#DE5021',"Bandits have secured a weapons deal, intercept it!"];
...
if (_difficulty isEqualTo "hardcore") then
{
	...
	_vehicle = ["rhs_kamaz5350",_pos getPos [30, random 360],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	_msgWIN = ['#DE5021',format ["Survivors have got their hands on the weapons, entry code for Kamaz is %1...",_pinCode]];
} else
{
	_vehicle = ["rhs_kamaz5350",_pos getPos [30, random 360]] call DMS_fnc_SpawnNonPersistentVehicle;
	_msgWIN = ['#DE5021',"Survivors have got their hands on the weapons"];
};
...
_msgLOSE = ['#DE5021',"The attackers stole everything, no guns for you..."];
// Define mission name (for map marker and logging)
_missionName = "Weapons Shipment";
