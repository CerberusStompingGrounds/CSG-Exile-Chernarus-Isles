...
_msgStart = ['#DE5021',"A DIY storage is under attack! Go kill the attackers"];
...
if (_difficulty isEqualTo "hardcore") then {
												...
												_msgWIN = ['#DE5021',format ["Survivors grabbed all the building materials, entry code is %1...",_pinCode]];
											} else
											{
												...
												_msgWIN = ['#DE5021',"Survivors grabbed all the building materials"];
											};
// Create Crate type
...
// Define msision-spawned AI Units
_missionAIUnits =
[
...
_msgLOSE = ['#DE5021',"The attackers stole everything..."];
