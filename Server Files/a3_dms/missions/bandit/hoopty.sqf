...
_msgStart = ['#DE5021',"Volunteers with an old hoopty have broken down. Go kill them and steal the car"];
// Define Mission Win message
_msgWIN = ['#DE5021',format ["Survivors killed everyone and made off with the hoopty, entry code %1...",_pinCode]];
// Define Mission Lose message
_msgLOSE = ['#DE5021',"The attackers drove off and escaped attack"];
