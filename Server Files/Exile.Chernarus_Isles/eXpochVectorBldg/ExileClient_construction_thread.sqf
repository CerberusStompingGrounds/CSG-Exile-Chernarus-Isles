...
if (_isFlag) then 
{
	["InfoTitleAndText", ["Flag Placement", "Do not place the flag underground or where you cannot steal it! It may get removed!"]] call ExileClient_gui_toaster_addTemplateToast;
