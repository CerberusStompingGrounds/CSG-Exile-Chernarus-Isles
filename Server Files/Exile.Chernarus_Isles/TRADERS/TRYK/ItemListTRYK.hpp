class TRYK_ESS_CAP {quality=1;price=10;};
class TRYK_ESS_CAP_OD {quality=1;price=10;};
class TRYK_ESS_CAP_tan {quality=1;price=10;};
class TRYK_R_CAP_BLK {quality=1;price=10;};
class TRYK_R_CAP_TAN {quality=1;price=10;};
class TRYK_R_CAP_OD_US {quality=1;price=10;};
class TRYK_r_cap_tan_Glasses {quality=1;price=10;};
class TRYK_r_cap_blk_Glasses {quality=1;price=10;};
class TRYK_r_cap_od_Glasses {quality=1;price=10;};
class TRYK_H_headsetcap_Glasses {quality=1;price=10;};
class TRYK_H_headsetcap_blk_Glasses {quality=1;price=10;};
class TRYK_H_headsetcap_od_Glasses {quality=1;price=10;};
class TRYK_H_Helmet_Winter {quality=1;price=60;};
class TRYK_H_Helmet_Winter_2 {quality=1;price=60;};
class TRYK_US_ESS_Glasses_H {quality=1;price=10;};
class TRYK_US_ESS_Glasses_NV {quality=1;price=3000;};
class TRYK_US_ESS_Glasses_TAN_NV {quality=1;price=3000;};
class TRYK_Headphone_NV {quality=1;price=3000;};
class TRYK_HRPIGEAR_NV {quality=1;price=3000;};
class TRYK_US_ESS_Glasses_Cover {quality=1;price=10;};
class TRYK_balaclava_BLACK_NV {quality=1;price=3000;};
class TRYK_balaclava_NV {quality=1;price=3000;};
class TRYK_balaclava_BLACK_EAR_NV {quality=1;price=3000;};
class TRYK_balaclava_EAR_NV {quality=1;price=3000;};
class TRYK_Shemagh_TAN_NV {quality=1;price=3000;};
class TRYK_Shemagh_MESH_NV {quality=1;price=3000;};
class TRYK_Shemagh_G_NV {quality=1;price=3000;};
class TRYK_Shemagh_WH_NV {quality=1;price=3000;};
class TRYK_Shemagh_EAR_NV {quality=1;price=3000;};
class TRYK_Shemagh_EAR_G_NV {quality=1;price=3000;};
class TRYK_Shemagh_EAR_WH_NV {quality=1;price=3000;};
class TRYK_ShemaghESSTAN_NV {quality=1;price=3000;};
class TRYK_ShemaghESSOD_NV {quality=1;price=3000;};
class TRYK_ShemaghESSWH_NV {quality=1;price=3000;};
class TRYK_ESS_BLKTAN_NV {quality=1;price=3000;};
class TRYK_ESS_BLKBLK_NV {quality=1;price=3000;};
class TRYK_Shemagh_shade_MESH {quality=1;price=10;};
class TRYK_Shemagh_shade_N {quality=1;price=10;};
class TRYK_Shemagh_shade_G_N {quality=1;price=10;};
class TRYK_Shemagh_shade_WH_N {quality=1;price=10;};
class TRYK_Headset_NV {quality=1;price=3000;};
class TRYK_TAC_EARMUFF_SHADE {quality=1;price=10;};
class TRYK_TAC_EARMUFF {quality=1;price=10;};
class TRYK_NOMIC_TAC_EARMUFF {quality=1;price=10;};
class TRYK_TAC_boonie_SET_NV {quality=1;price=3000;};
class TRYK_TAC_SET_NV_TAN {quality=1;price=3000;};
class TRYK_TAC_SET_NV_OD {quality=1;price=3000;};
class TRYK_TAC_SET_NV_WH {quality=1;price=3000;};
class TRYK_TAC_SET_NV_MESH {quality=1;price=3000;};
class TRYK_TAC_SET_NV_TAN_2 {quality=1;price=3000;};
class TRYK_TAC_SET_NV_OD_2 {quality=1;price=3000;};
class TRYK_TAC_SET_NV_WH_2 {quality=1;price=3000;};
class TRYK_TAC_SET_NV_MESH_2 {quality=1;price=3000;};
class TRYK_headset2 {quality=1;price=10;};
class TRYK_G_Shades_Black_NV {quality=1;price=3000;};
class TRYK_G_Shades_Blue_NV {quality=1;price=3000;};
class TRYK_G_bala_ess_NV {quality=1;price=3000;};
class TRYK_bandana_NV {quality=1;price=3000;};
class TRYK_SPgearG_NV {quality=1;price=3000;};
class TRYK_SPgear_PHC1_NV {quality=1;price=3000;};
class TRYK_SPgear_PHC2_NV {quality=1;price=3000;};
class TRYK_G_bala_wh_NV {quality=1;price=3000;};
class TRYK_ESS_wh_NV {quality=1;price=10;};
class TRYK_Kio_Balaclava {quality=1;price=10;};
class TRYK_H_Helmet_JSDF {quality=1;price=60;};
class TRYK_H_Helmet_CC {quality=1;price=60;};
class TRYK_H_Helmet_WOOD {quality=1;price=60;};
class TRYK_H_Helmet_ACU {quality=1;price=60;};
class TRYK_H_Helmet_MARPAT_Wood {quality=1;price=60;};
class TRYK_H_Helmet_MARPAT_Desert {quality=1;price=60;};
class TRYK_H_Helmet_MARPAT_Desert2 {quality=1;price=60;};
class TRYK_H_Helmet_3C {quality=1;price=60;};
class TRYK_H_Booniehat_JSDF {quality=1;price=10;};
class TRYK_H_Booniehat_3CD {quality=1;price=10;};
class TRYK_H_Booniehat_CC {quality=1;price=10;};
class TRYK_H_Booniehat_WOOD {quality=1;price=10;};
class TRYK_H_Booniehat_MARPAT_WOOD {quality=1;price=10;};
class TRYK_H_Booniehat_MARPAT_Desert {quality=1;price=10;};
class TRYK_H_Booniehat_AOR1 {quality=1;price=10;};
class TRYK_H_Booniehat_AOR2 {quality=1;price=10;};
class TRYK_H_PASGT_BLK {quality=1;price=60;};
class TRYK_H_PASGT_OD {quality=1;price=60;};
class TRYK_H_PASGT_COYO {quality=1;price=60;};
class TRYK_H_PASGT_TAN {quality=1;price=60;};
class TRYK_H_Helmet_Snow {quality=1;price=60;};
class TRYK_H_WH {quality=1;price=10;};
class TRYK_H_GR {quality=1;price=10;};
class TRYK_H_AOR1 {quality=1;price=10;};
class TRYK_H_AOR2 {quality=1;price=10;};
class TRYK_H_DELTAHELM_NV {quality=1;price=60;};
class TRYK_H_EARMUFF {quality=1;price=10;};
class TRYK_H_TACEARMUFF_H {quality=1;price=10;};
class TRYK_H_Bandana_H {quality=1;price=10;};
class TRYK_H_Bandana_wig {quality=1;price=10;};
class TRYK_H_Bandana_wig_g {quality=1;price=10;};
class TRYK_H_wig {quality=1;price=10;};
class TRYK_H_headset2 {quality=1;price=10;};
class TRYK_H_woolhat {quality=1;price=10;};
class TRYK_H_woolhat_CW {quality=1;price=10;};
class TRYK_H_woolhat_WH {quality=1;price=10;};
class TRYK_H_woolhat_br {quality=1;price=10;};
class TRYK_H_woolhat_cu {quality=1;price=10;};
class TRYK_H_woolhat_tan {quality=1;price=10;};
class TRYK_H_headsetcap {quality=1;price=10;};
class TRYK_H_headsetcap_blk {quality=1;price=10;};
class TRYK_H_headsetcap_od {quality=1;price=10;};
class TRYK_H_pakol {quality=1;price=10;};
class TRYK_H_pakol2 {quality=1;price=10;};
class TRYK_H_LHS_HEL_G {quality=1;price=60;};
class TRYK_V_PlateCarrier_JSDF {quality=1;price=1000;};
class TRYK_V_ArmorVest_AOR1 {quality=1;price=1000;};
class TRYK_V_ArmorVest_AOR2 {quality=1;price=1000;};
class TRYK_V_ArmorVest_coyo {quality=1;price=1000;};
class TRYK_V_ArmorVest_Brown {quality=1;price=1000;};
class TRYK_V_ArmorVest_CBR {quality=1;price=1000;};
class TRYK_V_ArmorVest_khk {quality=1;price=1000;};
class TRYK_V_ArmorVest_green {quality=1;price=1000;};
class TRYK_V_ArmorVest_tan {quality=1;price=1000;};
class TRYK_V_ArmorVest_Delta {quality=1;price=1000;};
class TRYK_V_ArmorVest_Ranger {quality=1;price=1000;};
class TRYK_V_ArmorVest_AOR1_2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_AOR2_2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_coyo2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_Brown2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_cbr2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_khk2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_green2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_tan2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_Delta2 {quality=1;price=3000;};
class TRYK_V_ArmorVest_Ranger2 {quality=1;price=3000;};
...
class TRYK_V_PlateCarrier_blk_L {quality=1;price=1000;};
class TRYK_V_PlateCarrier_wood_L {quality=1;price=1000;};
class TRYK_V_PlateCarrier_ACU_L {quality=1;price=1000;};
class TRYK_V_PlateCarrier_coyo_L {quality=1;price=1000;};
class TRYK_V_Bulletproof {quality=1;price=500;};
class TRYK_V_Bulletproof_BLK {quality=1;price=500;};
class TRYK_V_Bulletproof_BL {quality=1;price=500;};
class TRYK_V_PlateCarrier_blk {quality=1;price=1000;};
class TRYK_V_PlateCarrier_coyo {quality=1;price=1000;};
class TRYK_V_PlateCarrier_wood {quality=1;price=1000;};
class TRYK_V_PlateCarrier_ACU {quality=1;price=1000;};
class TRYK_V_IOTV_BLK {quality=1;price=1000;};
...
class TRYK_U_B_PCUHsW7 {quality=1;price=100;};
class TRYK_U_B_PCUHsW8 {quality=1;price=100;};
class TRYK_U_B_PCUHsW9							 {quality=1;price=100;};
...
class TRYK_B_Kitbag_Base {quality=1;price=1000;};
class TRYK_B_Kitbag_blk {quality=1;price=1000;};
class TRYK_B_Kitbag_aaf {quality=1;price=1000;};
class TRYK_B_Carryall_blk {quality=1;price=5000;};
class TRYK_B_Carryall_wh {quality=1;price=5000;};
class TRYK_B_Carryall_wood {quality=1;price=5000;};
class TRYK_B_Carryall_JSDF {quality=1;price=5000;};
class TRYK_B_Kitbag_Base_JSDF {quality=1;price=1000;};
class TRYK_B_Coyotebackpack {quality=1;price=5000;};
class TRYK_B_Coyotebackpack_OD {quality=1;price=5000;};
class TRYK_B_Coyotebackpack_BLK {quality=1;price=5000;};
class TRYK_B_Coyotebackpack_WH {quality=1;price=5000;};
class TRYK_B_Alicepack {quality=1;price=1000;};
class TRYK_B_Medbag {quality=1;price=1000;};
class TRYK_B_Medbag_OD {quality=1;price=1000;};
class TRYK_B_Medbag_BK {quality=1;price=1000;};
class TRYK_B_Medbag_ucp {quality=1;price=1000;};
class TRYK_B_Belt {quality=1;price=300;};
class TRYK_B_Belt_BLK {quality=1;price=300;};
class TRYK_B_Belt_CYT {quality=1;price=300;};
class TRYK_B_Belt_tan {quality=1;price=300;};
class TRYK_B_Belt_br {quality=1;price=300;};
class TRYK_B_Belt_GR {quality=1;price=300;};
class TRYK_B_Belt_AOR1 {quality=1;price=300;};
class TRYK_B_Belt_AOR2 {quality=1;price=300;};
class TRYK_B_BAF_BAG_BLK {quality=1;price=1000;};
class TRYK_B_BAF_BAG_CYT {quality=1;price=1000;};
class TRYK_B_BAF_BAG_OD {quality=1;price=1000;};
class TRYK_B_BAF_BAG_rgr {quality=1;price=1000;};
class TRYK_B_BAF_BAG_mcamo {quality=1;price=1000;};
class TRYK_B_tube_cyt {quality=1;price=300;};
class TRYK_B_tube_od {quality=1;price=300;};
class TRYK_B_tube_blk {quality=1;price=300;};
class TRYK_B_FieldPack_Wood {quality=1;price=1000;};
class TRYK_Winter_pack {quality=1;price=1000;};